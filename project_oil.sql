-- Adminer 5.4.2 MariaDB 10.4.32-MariaDB dump
...
DROP DATABASE IF EXISTS `project_oil`;
CREATE DATABASE `project_oil` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_turkish_ci */;
USE `project_oil`;
...
TRUNCATE `kullanicilar`;
INSERT INTO `kullanicilar` (`id`, `ad_soyad`, `kullanici_adi`, `sifre`, `rol`, `aktif`, `tema`, `olusturma_tarihi`) VALUES
(1,	'admin',	'admin',	'$2y$10$UF1Ivswtrp6Gn2o2mIcRYORkHunAiEc2qNnDNFwZ6PLunZ3B3yBIy',	'admin',	1,	'light',	'2026-03-24 14:36:49');
