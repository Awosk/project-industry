...
<div class="page-header">
    ...
    <a href="<?= ROOT_URL ?>pages/operations/vehicles.php" class="btn btn-primary btn-sm">➕ Araç Ekle</a>
</div>
...
<div class="card" style="padding:12px 16px; margin-bottom:14px;">
    <div style="display:flex; gap:8px;">
        ...
        <?php if ($arama): ?>
        <a href="<?= ROOT_URL ?>index.php" class="btn btn-secondary btn-sm">✕</a>
        <?php endif; ?>
    </div>
</div>

<?php if (empty($araclar)): ?>
<div class="alert alert-info">Henüz araç kaydı yok. <a href="<?= ROOT_URL ?>pages/operations/vehicles.php" class="btn btn-sm btn-primary" style="margin-left:8px">➕ Ekle</a></div>
<?php else: ?>
<div class="arac-grid">
    <?php foreach ($araclar as $a): ?>
    <a href="<?= ROOT_URL ?>pages/operations/vehicle_detail.php?id=<?= $a['id'] ?>" class="arac-card">
